...
namespace RasControlWeb
{
    public partial class BurnDown : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            XmlNode sprints = service.XmlBurnDown(Int32.Parse(TextBox1.Text), Int32.Parse(TextBox2.Text));

           // XmlNodeList sprints = xml.GetElementsByTagName("Sprint");
       ...
       /* 
          ...
          // XmlDocument xml = webService.XmlBurnDown(Int32.Parse(TextBox1.Text), Int32.Parse(TextBox2.Text));
