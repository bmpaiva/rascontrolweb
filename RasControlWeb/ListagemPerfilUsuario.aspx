<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListagemPerfilUsuario.aspx.cs" Inherits="RasControlWeb.ListagemPerfilUsuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <table>
    <tr>
        <td style="font-weight: bold; color: #000000;">Pesquisa de Perfil</td>       
    </tr>
    <tr>
        <td> </td>       
    </tr>
  ...
  <br />
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" 
            ...
            onrowcommand="GridView1_RowCommand" ForeColor="Black" Width="438px">
...
<asp:BoundField DataField="Descricao" HeaderText="Descricao" SortExpression="Descricao"></asp:BoundField>
                ...
                <asp:ButtonField CommandName="Permissoes" Text="Permissões" />
            </Columns>
    ...
    <br />
        ...
        &nbsp;<asp:Button ID="btIncluir" runat="server" Text="Incluir" 
            onclick="btIncluir_Click" Width="130px" />
