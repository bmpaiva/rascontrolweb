...
namespace IDAO
{
    public interface IDAOPermissao
    {
        ...
        // permissão perfil
        List<Permissao> ConsultarAllPermissaoPerfil(int idPerfil);
        void CadastrarPermissaoPerfil(int idPerfil, Permissao permissao);
        void DeletePerfilPermissao(int idPerfil, int idPermissao);
    }
}